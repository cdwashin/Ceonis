...
export default function WorldScreen({ galaxy, curriculum, onBack, devMode, onLessonComplete, onWordLearned, onBadgeEarned, lessonsCompleted, accessibility }) {
                ...
                <div style={{display:'flex',gap:11,alignItems:'flex-start'}}>
                  ...
                  <div style={{flex:1}}>
                    ...
                    <div style={{display:'flex',gap:6,flexWrap:'wrap',alignItems:'center'}}>
                      ...
                      {completed&&bestScore!==undefined&&<span style={{fontSize:10,color:color,fontWeight:700,padding:'2px 8px',borderRadius:999,background:`${color}18`,border:`1px solid ${color}30`}}>Best: {bestScore}%</span>}
                    </div>
                  </div>
                </div>
              </div>
